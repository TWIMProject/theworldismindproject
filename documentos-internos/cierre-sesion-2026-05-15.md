...
10. **`documentos-internos/palancas-venta-libro-engranajes-15-may-2026.md`** · (operativo, no orientación) playbook de venta del libro. Automation Cap III creada vía MCP el 15 may (id `187569220715808525`, `enabled: false`); pendiente solo: Daniel pulsa Activar + env var Netlify. Incluye decisión pendiente Amazon-nativo.
