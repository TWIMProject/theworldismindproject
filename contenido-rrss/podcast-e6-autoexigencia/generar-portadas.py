"""Genera las 3 portadas del E6 «El mandato de no parar» (autoexigencia).

Hereda el sistema visual establecido en E1-E4 (NotebookLM) y heredado al
formato humano: foto autor + tipografía serif display + jerarquía editorial
sobre verde oscuro. Originalmente era el E5; tras el reordenamiento del
...
DESTINO = REPO / "contenido-rrss" / "podcast-e6-autoexigencia"
